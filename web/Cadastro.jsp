...
<html>
    ...
    <body>
        <div class="container">
            <h1>Tela Cadastro de Pipoca (WebServlet)</h1>
            <div class="row">

                <div class="col-md-6">
                    <form action="acao/Conexao" method="POST" id="cadastro">
                ...
                <div class="col-md-6">
                    <form action="acao/Conexao" method="POST" id="consulta">
            ...
            <%}%>
            <hr>
            <a href="CadastroConexaoAternativa.jsp" class="btn btn-sm btn-primary" target="new">Cadastro com JSP-JSP</a>
        </div>
    </body>
</html>
<%
